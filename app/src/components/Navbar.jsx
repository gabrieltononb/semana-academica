  ...
  return (
    <header className="app-navbar" data-testid="app-navbar">
      ...
      <nav className="navbar-navigation">
        <button
          type="button"
          className={`nav-tab ${telaAtiva === 'programacao' ? 'active' : ''}`}
          onClick={() => aoMudarTela('programacao')}
          data-testid="tab-programacao"
        >
          Programação
        </button>
        <button
          type="button"
          className={`nav-tab ${telaAtiva === 'criar' ? 'active' : ''}`}
          onClick={() => aoMudarTela('criar')}
